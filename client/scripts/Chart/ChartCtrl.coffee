...
.controller('morrisChartCtrl', [
    ...
    ($scope) ->
        ...
        $scope.comboData = [
            { month: 'Jan', a: 20, b: 16, c: 12 }
            { month: 'Feb', a: 10, b: 22, c: 30 }
            { month: 'Mar', a: 5, b: 14, c: 20 }
            { month: 'Apr', a: 5, b: 12, c: 19 }
            { month: 'May', a: 20, b: 19, c: 13}
            { month: 'Jun', a: 28, b: 22, c: 20 }
        ]

        $scope.donutData = [
            {label: "Fruits", value: 12}
            {label: "Vegetables", value: 30}
            {label: "Grains", value: 20}
            {label: "Milk", value: 19}
            {label: "Meat/Poultry", value: 19}
        ]
])
